...
Q_IMPORT_QML_PLUGIN(Schedule_makerPlugin)
Q_IMPORT_QML_PLUGIN(Schedule_makerContentPlugin)

const char mainQmlFile[] = "qrc:/qt/qml/Schedule_makerContent/App.qml";
